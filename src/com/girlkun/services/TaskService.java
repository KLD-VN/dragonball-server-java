...
//         if (!player.isBoss && !player.isPet && !player.isNewPet && !player.isPetEvent) {
...
//      if (!player.isBoss && !player.isPet && !player.isNewPet&& !player.isPetEvent && item != null) {
...
//        if (player != null && !player.isBoss && !player.isPet && !player.isNewPet && player.isPetEvent) {
//            switch ((int) boss.id) {
//                case BossID.KUKU:
...
//         if (player.isPet || player.isNewPet || player.isPetEvent || player.isBoss || player.playerTask == null || player.playerTask.taskMain == null) {
//            return -1;
//        }
