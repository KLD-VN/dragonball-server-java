...
public class SummonDragon {
    ...
    private final int timeResummonShenron = 300000; // time delay nro
            ...
            case ConstNpc.SHENRON_1_2:
                switch (this.select) {
                    ...
                    case 1: //+1,5 ngọc
                        ...
                        break;
                    case 2: //+200 tr smtn
                        if (this.playerSummonShenron.nPoint.power <= 500000000) {
                            Service.getInstance().addSMTN(this.playerSummonShenron, (byte) 2, 200000000, false);
                        } else {
                            Service.getInstance().sendThongBao(playerSummonShenron, "chức năng mở lại sau khi kết thúc đua top sức mạnh.");
                            reOpenShenronWishes(playerSummonShenron);
                            return;
                        }
                        break;
