                ...
                default:
                    switch (item.template.id) {
                        ...
                        case 1107:
                            ...
                            break;
                        case 457:
                            if (pl.inventory.gold < 2000000000) {
                                long _vang = ((long) pl.inventory.gold + 500000000) > 2000000000L ? 2000000000L : ((long) pl.inventory.gold + 500000000);
                                pl.inventory.gold = _vang;
                                InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
                                Service.getInstance().sendMoney(pl);
                            } else {
                                Service.getInstance().sendThongBao(pl, "MAX");
                            }
