...
//nro namec
    ...
    public boolean isPetEvent;

    public IPVP pvp;
    public int pointPvp;

    public PetEvent petevent;
...
public int maxpvpclone;
    ...
    public boolean isPl() {
        return !isPet && !isBoss && !isNewPet && !isPetEvent;
    }
        ...
        if (!this.beforeDispose) {
            try {
                if (!iDMark.isBan()) {
                    ...
                    if (this.isPl() && petevent != null && petevent.isDie() == true) {
                        petevent.dispose();
                        petevent = null;
                    }
...
//        return -1;
    ...
    protected void setDie(Player plAtt) {
        ...
        //add kẻ thù
        if (!this.isPet && !this.isNewPet && !this.isBoss && plAtt != null && !plAtt.isPet && !plAtt.isPetEvent && !plAtt.isBoss) {
