...
//                    if (player.nPoint.dameg > 32000) {
//                        player.nPoint.dameg = 32000;
//                    }
//                    if (player.nPoint.hpg > 600000) {
//                        player.nPoint.hpg = 600000;
//                    }
//                    if (player.nPoint.mpg > 600000) {
//                        player.nPoint.mpg = 600000;
//                    }
//                    if ((InventoryServiceNew.gI().findItemBag(player, 457).isNotNullItem() && InventoryServiceNew.gI().findItemBag(player, 457).quantity > 500 )|| (InventoryServiceNew.gI().findItemBag(player, 457).isNotNullItem() && InventoryServiceNew.gI().findItemBag(player, 457).quantity > 100 && player.getSession().actived == false) ) {
