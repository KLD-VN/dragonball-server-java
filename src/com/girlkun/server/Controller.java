...
public class Controller implements IMessageHandler {
    ...
    public void onMessage(ISession s, Message _msg) {
        ...
        System.out.println(_msg.command);
...
//        Service.getInstance().sendThongBaoOK(session, "Vui lòng đăng ký tài khoản tại trang chủ https://nrovn.xyz!");
    }
