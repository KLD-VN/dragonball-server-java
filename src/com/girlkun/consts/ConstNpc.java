...
public class ConstNpc {
    ...
    public static final byte BUNMA_TOC_NAU = 94;
    public static final byte TRUNG_LINH_THU = 96;
   ...
   public static final int CONFIRM_TELE_NAMEC = 522;
    ...
    //index menu mua vang
    public static final int BUY_VANG = 501;

    public static final int BUY_HONHG_NGOC = 502;
    ...
    //index menu NGOKHONG
    public static final int MENU_NHAN_DE_TU_NGO_KHONG = 500;
    public static final int MENU_NOT_NHAN_DE_TU_NGO_KHONG = 501;
}
